...
- a scoring scheme compatible with SUS-style interpretation (0–100)
...
- the **SHS scale definition**
- documentation and usage guidelines
- supporting tools and materials for applying SHS in studies and evaluations
...
- Comparative testing of language models
- Monitoring hallucination tendencies in deployed systems
- Research on trust, reliability, and human–AI interaction
